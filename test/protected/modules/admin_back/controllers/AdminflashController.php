...
class AdminflashController extends AdminController
{
	...
	public function actionCreate()
	{
        ...
        Service::addLog('新建falsh 图片，内容是：'.json_encode($_POST['Flash']));
            }
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Flash']))
		{
			...
			if($model->save())
             Service::addLog('更新falsh 图片，有：'.json_encode($model_info).' 更该为：'.json_encode($model->attributes));
				$this->redirect(array('view','id'=>$model->id));
		}
	...
	public function actionDelete($id)
	{
        ...
        $model_info->delete();
        Service::addLog('删除falsh 图片，内容是：'.json_encode($model_info->attributes));
