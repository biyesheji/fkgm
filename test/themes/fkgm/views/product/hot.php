                ...
                ?>
                    <li <?php echo $i%3 == 0 ? "class = 'nomargin'" : '';?> >
                        ...
                        <div class="ts-display-pf-text">
                            ...
                            <a href="<?php echo $this->createUrl('product/detail',array('id' => $value->id));?>" target='_blank' class="button">查看更多</a> <!-- <a href="<?php //echo $this->createUrl('product/comment',array('id' => $value->id));?>" class="button">查看评论</a> -->
                        </div>
